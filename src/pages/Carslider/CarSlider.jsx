...
const CarCard = ({ car }) => (
 <div className="w-[210px] border rounded-md shadow-sm hover:shadow-md transition-transform duration-300 hover:-translate-y-1 bg-white flex-shrink-0 text-xs">
  <div className="relative">
    <img
      src={car.img}
      alt={car.name}
      className="w-full h-20 object-cover rounded-t-md transform hover:scale-105 transition duration-300"
    />
  ...
  return (
      ...
      <div className="flex gap-4 p-2">
        {cars.map((car, index) => (
          <div
            key={index}
            className="min-w-[280px] max-w-[300px] bg-white rounded-md border shadow-md hover:shadow-lg transition-all"
          >
            {/* Image */}
            <div className="relative h-48 overflow-hidden rounded-t-md">
              ...
              <div className="absolute bottom-0 w-full bg-white text-xs text-center py-1 border-t text-black font-medium">
                {car.year >= 2020 ? "1 Year Warranty" : "6 Months Warranty"} | 3 Free Service
              </div>
            </div>
            ...
            <div className="p-3">
              ...
              {/* Price */}
              <p className="mt-2 text-xl font-bold text-[#003B9F]">{car.price}</p>
